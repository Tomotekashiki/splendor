        ...
        <div v-if="authMode === 'login'" class="space-y-4">
          ...
          <div class="relative glass-input rounded-xl flex items-center">
            ...
            <input 
              ...
              class="flex-grow outline-none px-3.5 py-3.5 font-mono rounded-r-xl"
              style="background: transparent; color: #0C447C; -webkit-text-fill-color: #0C447C; caret-color: #0C447C;"
              required
            />
          </div>
          ...
          <div class="relative glass-input rounded-xl flex items-center">
            <input 
              ...
              class="w-full outline-none px-3.5 py-3.5 pr-10 rounded-xl"
              style="background: transparent; color: #0C447C; -webkit-text-fill-color: #0C447C; caret-color: #0C447C;"
              required
            />
            <button
        ...
        <div v-else-if="authMode === 'signup'" class="space-y-4">
          ...
          <div class="relative glass-input rounded-xl">
            <input 
              ...
              class="w-full outline-none px-3.5 py-3.5 rounded-xl"
              style="background: transparent; color: #0C447C; -webkit-text-fill-color: #0C447C; caret-color: #0C447C;"
              required
            />
          </div>
          ...
          <div v-else-if="forgotForm.forgotStep === 2" class="space-y-4 text-center">
            ...
            <div class="flex justify-center gap-3 py-2">
              <input 
                ...
                class="w-32 h-14 text-center text-2xl font-mono glass-input rounded-xl font-bold tracking-widest"
                style="color: #0C447C; -webkit-text-fill-color: #0C447C; caret-color: #0C447C;"
              />
            </div>
