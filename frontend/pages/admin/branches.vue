          ...
          <table class="w-full text-left text-xs border-collapse min-w-[600px]">
            <thead>
              <tr class="border-b border-brand-100 text-brand-500 font-bold uppercase tracking-wider">
                <th class="pb-4 font-semibold w-16 text-center border-r border-brand-100">{{ localeStore.t('order') }}</th>
                <th class="pb-4 font-semibold w-1/4 pl-5">{{ localeStore.t('branch_name') }}</th>
            ...
            <tbody class="divide-y divide-brand-100 text-brand-600">
              ...
              >
                <!-- Reordering controls -->
                <td class="py-4 align-middle text-center border-r border-brand-100">
                ...
                <!-- Branch Name -->
                <td class="py-4 align-middle font-bold text-[#0C447C] text-sm pl-5">
